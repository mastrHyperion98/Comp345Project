 ...
 */
	...
	map.placeHarvestTile(5, *(new HarvestTile));
	map.placeHarvestTile(6, *new HarvestTile);
	map.placeHarvestTile(7, *new HarvestTile);
	map.placeHarvestTile(8, *new HarvestTile);
	map.placeHarvestTile(9, *new HarvestTile);
	map.placeHarvestTile(10, *new HarvestTile);
	map.placeHarvestTile(11, *new HarvestTile);
	map.placeHarvestTile(13, *new HarvestTile);
	map.placeHarvestTile(14, *new HarvestTile);
	map.placeHarvestTile(16, *new HarvestTile);
	map.placeHarvestTile(17, *new HarvestTile);
	map.placeHarvestTile(18, *new HarvestTile);
	map.placeHarvestTile(19, *new HarvestTile);
