...
void GameController::start(){
    ...
    // this is the GameStatistic Observer
...
// implement a get/setState function

void GameController::setState(States state) {
    *game_state = state;
    // tell the controllers the state has changed
    notify();
}

States GameController::getState() {
    return *game_state;
}