...
{
	std::int_fast8_t j{ 1 }, i{ (index + j) % 4 }, total{ 1 }; //total defaults to one because we count the resource at the index. j defaults to 1 because we want to check the index right after the current one.
	/*
